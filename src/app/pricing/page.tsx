...
export default function BuyPage() {
  const { user, isSignedIn, profile, isLoading: isLoadingUser } = useUser();
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-lg text-slate-300">
              Get unlimited access to all Pixel Nova features and create
              stunning pixel art with AI.
            </p>
          </div>
          ...
          {profile?.pro_overriden && (
            <Alert className="mx-auto mb-8 max-w-2xl bg-green-900">
              ...
              <AlertDescription>
                ...
                subscription. You will not be able to buy the pro plan nor
                manage your subscription. Contact{" "}
                <a
